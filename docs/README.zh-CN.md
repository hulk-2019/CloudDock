...
| 扩展弹窗                                                                     | 文件网格视图                                                                 |
| ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| <img src="../public/image-1.png" alt="CloudDock 扩展弹窗" width="420" />     | <img src="../public/image-2.png" alt="CloudDock 文件网格视图" width="420" /> |
| **文件列表视图**                                                             | **配置管理**                                                                 |
| <img src="../public/image-3.png" alt="CloudDock 文件列表视图" width="420" /> | <img src="../public/image-4.png" alt="CloudDock 配置管理界面" width="420" /> |
...
- **中英文界面**：可在运行时切换简体中文与英文，语言偏好会在扩展页面之间同步。
